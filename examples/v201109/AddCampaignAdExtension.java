...
import com.google.api.adwords.v201109.cm.CampaignAdExtensionOperation;
import com.google.api.adwords.v201109.cm.CampaignAdExtensionReturnValue;
...
import com.google.api.adwords.v201109.cm.LocationExtension;
import com.google.api.adwords.v201109.cm.LocationExtensionSource;
  ...
  public static void main(String[] args) {
   ...
   // Log SOAP XML request and response.
      ...
      CampaignAdExtensionServiceInterface campaignAdExtensionService =
          user.getService(AdWordsService.V201109.CAMPAIGN_AD_EXTENSION_SERVICE);

      // Get the GeoLocationService.
      GeoLocationServiceInterface geoLocationService =
          user.getService(AdWordsService.V201109.GEO_LOCATION_SERVICE);
