...
import com.google.api.adwords.v201109_1.cm.AdGroupAdPage;
 ...
 * AddAds.java. To get ad groups, run GetAllAdGroups.java.
 *
...
public class GetAllDisapprovedAds {
  public static void main(String[] args) {
    try {
      ...
      Predicate approvalStatusPredicate =
          new Predicate("CreativeApprovalStatus", PredicateOperator.IN,
              new String[] {"DISAPPROVED"});
